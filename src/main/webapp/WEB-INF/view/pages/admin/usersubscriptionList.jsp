					...
					<tbody>
						<c:forEach var="list" items="${userSubscriptionList}">
							<tr>
								...
								<td class="text-center align-middle">${list.purchaseDate}</td>
								<td class="text-center align-middle">${list.period}일</td>
								<td class="text-center align-middle">${list.startDate}</td>
								<td class="text-center align-middle">${list.endDate}</td>

		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<div class="card">
					...
					<div class="card-body">
						<form action="/sc-product/edit/${product.spId}" id="edit-btn" method="post">
							...
							<div class="form-group">
								<label for="name">상품이름</label> <input type="text"
									class="form-control" id="prodName" name="prodName" value="${product.prodName}"
									required>
							</div>
			...
			<div class="form-group">
                            								<label for="name">기간</label> <input type="text"
                            									class="form-control" id="period" name="period" value="${product.period}"
                            									required>
                            							</div>
